...
<form method="post" action="?name=ffk.im&iframe=config&action=save">
...
<li class="current"><a href="?name=ffk.im&iframe=config"><span>全局配置</span></a></li>
...
<tr><td colspan="2" class="td27">客服QQ:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="<?php echo IN_QQ; ?>" name="IN_QQ"></td><td class="vtop tips2">网页显示客服QQ</td></tr>
<tr><td colspan="2" class="td27">邮箱地址:</td></tr>
...
$str=preg_replace("/'IN_QQ', '(.*?)'/", "'IN_QQ', '".SafeRequest("IN_QQ","post")."'", $str);
...
$str=preg_replace("/'IN_TOPTXT', '(.*?)'/", "'IN_TOPTXT', '".SafeRequest("IN_TOPTXT","post")."'", $str);
