...
<style type="text/css">
	...
	.btn-primary {color: #fff;background-color: #ee0640;border-color: #ff0045;width:100%;margin:5px 0;}
	.btn-primary:focus,.btn-primary.focus {color: #fff;background-color: #c01406;border-color: #ff0045;}
	.btn-primary:hover {color: #fff;background-color: #0066ff;border-color: #0066ff;}
	.btn-primary:active,.btn-primary.active{color: #fff;background-color: #ee0640;border-color: #ee0640;}
	.btn-success {color: #fff;background-color: ##0066ff;border-color: ##0066ff;width:100%;margin:5px 0;}
	.btn-success:hover {color: #fff;background-color: #ee0640;border-color: #ee0640;}
...
<div class="container text-center" style="line-height:30px;">
</div>
<div class="container">
<div class="grid-3"></div>
<div class="grid-6 text-center">
<img src="<?php if($imgUrlnew==null||$imgUrlnew==''){ echo $imgUrl ; }else{ echo $imgUrlnew;}?>" height="100px">

<div>
<a class="btn btn-warn btn-lg" href="javascript:void(0)" onclick="toggleBox(&#39;pop-window&#39;)">安装前必读</a>
</div>
...
?>	
  <style>
	...
	<div style="border-top:1px solid #dae2e3;padding:20px 20px 90px;margin-top:20px;text-align:center;color:#a9b1b3;">
      <?php echo $_SERVER['HTTP_HOST']; ?> 是应用内测平台，请自行甄别应用风险！如有问题可通过邮件反馈。<div style="margin-top:10px;"><a class="one-key-report" href="mailto:<?php echo IN_MAIL; ?>">联系我们</a></div>
	</div>
<div>
</div>
<div class="grid-4">
	...
	<div class="box" id="pop-window" onclick="toggleBox(&#39;pop-window&#39;)" style="display: none;">
    <div class="box-content">
	<p style="font-weight:150%;font-size:18px;margin-top:20px;color:red;text-align:center;">
	<span style="font-size:20px;color:red;font-weight:bold;">温馨提示<br>
<?php echo $hjcontext;?></span>
	<span class="right"><font size="" color="red">关闭</font></span>
	</div></div>
