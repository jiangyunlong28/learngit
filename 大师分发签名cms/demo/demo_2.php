...
<style type="text/css">
	...
	.btn-warn4 {color: #fff;background-color: #ff42e1;border-color: #ff42e1;width:100%;margin:15px 0;}
...
<body>
		...
		<div class="container">
			...
			<div class="grid-6 text-center">
				<h2 class="text-center" style="line-height:60px;background-color: #d5d5d5;border-radius: 100px;"> <?php echo $hjtitle;?></h2>
</br>
<b>

 <div style="width:100%;text-align:center;background-color: #000000;font-size:12px;color:#fff;line-height:20px;margin:5px 0 ;border-radius: 4px;padding:5px 16px">
...
<?php echo $hjcontext;?>
              ...
              <?php if($urlArray[0]['c2']!=''&&$urlArray[0]['c2']!=null&&$urlArray[0]['n2']!=''&&$urlArray[0]['n2']!=null){ ?>
                ...
                <?php } ?>
         		 ...
         		 <div>
					<a class="btn btn-warn btn-lg" href="javascript:void(0)" onclick="toggleBox(&#39;pop-window&#39;)">售后必读</a>
				</div>
...
-->
	<script type="text/javascript">
		...
		var winHeight = typeof window.innerHeight != 'undefined' ? window.innerHeight : document.documentElement.clientHeight;
          var weixinTip = $('<div id="weixinTip"><p><img src="demo/img/live_weixin_ios.png" alt="微信打开"/></p></div>');
