...
if(file_exists($lock)) {
show_msg('警告！您已经安装过大师分发！<br>为了保证数据安全，请立即删除{install.php}文件！<br>如果您想重新安装大师分发，请删除{data/install.lock}文件！',999);
}
...
print"	<div class=\"setup step1\">
	...
	<p>版权所有 (c) 2019-$year 大师分发保留所有权利。</p>

	<p>91dsCMS 是 大师分发 推出的一款以PHP语言开发的Web内容管理系统，帮助网站实现一站式服务。</p>

	<p>用户须知：本协议是您与大师分发之间关于您使用大师分发提供的软件产品及服务的法律协议。无论您是个人或组织、盈利与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，包括免除或者限制大师分发的免责条款及对您的权利限制。请您审阅并接受或不接受本服务条款。如您不同意本服务条款及/或大师分发随时对其的修改，您应不使用或主动取消大师分发提供的产品。否则，您的任何对大师分发产品中的相关服务的注册、登陆、下载、查看等使用行为将被视为您对本服务条款全部的完全接受，包括接受大师分发对服务条款随时所做的任何修改。</p>

	<p>本服务条款一旦发生变更, 大师分发将在网页上公布修改内容。修改后的服务条款一旦在网页上公布即有效代替原来的服务条款。您可随时登陆大师分发官方网址查阅最新版服务条款。如果您选择接受本条款，即表示您同意接受协议各项条件的约束。如果您不同意本服务条款，则不能获得使用本服务的权利。您若有违反本条款规定，大师分发有权随时中止或终止您对大师分发产品的使用资格并保留追究相关法律责任的权利。</p>

	<p>在理解、同意、并遵守本协议的全部条款后，方可开始使用大师分发产品。您可能与大师分发直接签订另一书面协议，以补充或者取代本协议的全部或者任何部分。</p>

	<p>大师分发拥有本软件的全部知识产权。本软件只供许可协议，并非出售。大师分发只允许您在遵守本协议各项条款的情况下复制、下载、安装、使用或者以其他方式受益于本软件的功能或者知识产权。</p>

	<h3>I. 协议许可的权利</h3>
	<ol>
	&nbsp;  <li>您可以在完全遵守本许可协议的基础上，将本软件应用于非商业用途，而不必支付软件版权许可费用。</li>
	&nbsp;  <li>您可以在协议规定的约束和限制范围内修改大师分发产品源代码(如果被提供的话)或界面风格以适应您的网站要求。</li>
	&nbsp;  <li>您拥有使用本软件构建的网站中全部会员资料、文章及相关信息的所有权，并独立承担与使用本软件构建的网站内容的审核、注意义务，确保其不侵犯任何人的合法权益，独立承担因使用大师分发软件和服务带来的全部责任，若造成大师分发或用户损失的，您应予以全部赔偿。</li>
	&nbsp;  <li>若您需将大师分发软件或服务用户商业用途，必须另行获得大师分发的书面许可，您在获得商业授权之后，您可以将本软件应用于商业用途，同时依据所购买的授权类型中确定的技术支持期限、技术支持方式和技术支持内容，自购买时刻起，在技术支持期限内拥有通过指定的方式获得指定范围内的技术支持服务。商业授权用户享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。</li>
	&nbsp;  <li>您可以从大师分发提供的应用中心服务中下载适合您网站的应用程序，但应向应用程序开发者/所有者支付相应的费用。</li>
	</ol>

	<h3>II. 协议规定的约束和限制</h3>
	<ol>
	&nbsp;  <li>未获大师分发书面商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆www.91ds.vip参考相关说明，也可以发送邮件到web@eardev.com了解详情。</li>
	&nbsp;  <li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
	&nbsp;  <li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用大师分发产品的整体或任何部分，未经书面许可，页面页脚处的大师分发产品名称和大师分发下属网站（www.91ds.vip）的链接都必须保留，而不能清除或修改。</li>
	&nbsp;  <li>禁止在大师分发产品的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</li>
	...
	&nbsp;  <li>大师分发不对使用本软件构建的网站中的文章或信息承担责任，全部责任由您自行承担。</li>
	&nbsp;  <li>大师分发无法全面监控由第三方上传至应用中心的应用程序，因此不保证应用程序的合法性、安全性、完整性、真实性或品质等；您从应用中心下载应用程序时，同意自行判断并承担所有风险，而不依赖于大师分发。但在任何情况下，大师分发有权依法停止应用中心服务并采取相应行动，包括但不限于对于相关应用程序进行卸载，暂停服务的全部或部分，保存有关记录，并向有关机关报告。由此对您及第三人可能造成的损失，大师分发不承担任何直接、间接或者连带的责任。</li>
	&nbsp;  <li>大师分发对其提供的软件和服务之及时性、安全性、准确性不作担保，由于不可抗力因素、大师分发无法控制的因素（包括黑客攻击、停断电等）等造成软件使用和服务中止或终止，而给您造成损失的，您同意放弃追究大师分发责任的全部权利。</li>
	&nbsp;  <li>大师分发特别提请您注意，大师分发为了保障公司业务发展和调整的自主权，大师分发拥有随时经或未经事先通知而修改服务内容、中止或终止部分或全部软件使用和服务的权利，修改会公布于大师分发网站相关页面上，一经公布视为通知。 大师分发行使修改或中止、终止部分或全部软件使用和服务的权利而造成损失的，大师分发不需对您或任何第三方负责。</li>
	</ol>

	<p>有关大师分发产品最终用户授权协议、商业授权与技术服务的详细内容，均由大师分发独家提供。大师分发拥有在不事先通知的情况下，修改授权协议和服务价目表的权利，修改后的协议或价目表对自改变之日起的新授权用户生效。</p>

	<p>一旦您开始安装大师分发产品，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权利的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。</p>

	<p>本许可协议条款的解释，效力及纠纷的解决，适用于中华人民共和国大陆法律。</p>

	<p>若您和大师分发之间发生任何纠纷或争议，首先应友好协商解决，协商不成的，您在此完全同意将纠纷或争议提交大师分发所在地人民法院管辖。大师分发拥有对以上各项条款内容的解释权及修改权。</p>

	<p>（正文完）</p>

	<p align=\"right\">大师分发</p>
	</div>
	</div>
...
print"	<div class=\"setup step2\">
    ...
    <td><input type=\"text\" name=\"dbtablepre\" value=\"prefix_\" size=\"35\" class=\"txt\"  style=\"display:none\"></td>
	<td></td>
	</tr>
	</table>
...
if(install_db_query($sql,$db)) {
fwrite(fopen('data/install.lock','wb+'),time());
show_msg('恭喜！大师分发 顺利安装完成！<br>为了保证数据安全，请手动删除{static/install}目录！<br><br>您的后台管理员帐号与前台会员帐号已经成功建立。接下来，您可以：<br><br><a href="index.php" target="_blank">进入网站首页</a><br>或 <a href="admin.php" target="_blank">进入管理后台</a> 以管理员身份对站点参数进行设置！',999);
}else {
...
print"	<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
	...
	<div class=\"header\">
	<h1>大师分发 安装向导</h1>
	<span>大师分发 $version 简体中文$charset $build</span>";
}
function show_footer() {
global $year;
print"	<div class=\"footer\">&copy;2011 - $year <a href=\"http://www.91ds.vip/\" target=\"_blank\">EarDev</a> Inc.</div>
	</div>
	</div>
	</body>
	</html>";
